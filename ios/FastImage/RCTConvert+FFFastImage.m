...
+ (FFFastImageSource *)FFFastImageSource:(id)json {
    ...
    BOOL cacheKeyIgnoreURLParams = [self BOOL:json[@"cacheKeyIgnoreURLParams"]];
    ...
    FFFastImageSource *imageSource = [[FFFastImageSource alloc] initWithURL:uri priority:priority headers:headers cacheControl:cacheControl cacheKeyIgnoreURLParams:cacheKeyIgnoreURLParams];
